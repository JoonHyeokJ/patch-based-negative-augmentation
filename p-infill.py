# Implementation of P-Infill in the paper "Understanding and Improving Robustness of Vision Transformers through Patch-based Negative Augmentation"
...
class P_Infill(object):
    def __init__(self, replace_rate):  # replace_rate: Now implemented in the case of 0.25 and 0.375.
        self.replace_rate = replace_rate
        if not (self.replace_rate in [0.25, 0.375]): raise Exception("Sorry, but the case of replace_rate {} is not implemented.".format(self.replace_rate))
...
class P_Infill_batch(nn.Module):
    def __init__(self, replace_rate):
        super(P_Infill_batch, self).__init__()
